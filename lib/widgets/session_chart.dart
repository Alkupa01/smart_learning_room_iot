            ...
            sideTitles: SideTitles(
              ...
              getTitlesWidget: (val, _) {
                ...
                return Padding(
                  ...
                  child: Text(widget.data[i].day,
                    style: TextStyle(
                      fontSize: 10,
                      fontWeight: _touched == i ? FontWeight.w700 : FontWeight.w400,
                      color: _touched == i ? const Color(0xFF1D9E75) : Colors.grey.shade500,
                    ),
                  ),
                );
              },
...
class ComfortLineChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (data.isEmpty) {
      return Center(
        child: Text('Belum ada data sesi hari ini',
